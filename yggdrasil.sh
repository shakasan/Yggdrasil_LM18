...
function installBase () {
  ...
  runCmd "sudo apt-get install -y sysstat"; smsgn "Installing sysstat"
}
...
function installMultimedia () {
  ...
  runCmd "sudo apt-get install -y quodlibet python-cddb python-musicbrainz2"; smsgn "Installing quodlibet"
...
KeyIDuDev "udev rules for Key-ID U2F key" \
...
KeyIDuDev)
clear; installKeyIDuDev; pressKey;;
